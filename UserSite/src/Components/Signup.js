    ...
    <>
      <div className='container mt-5 pt-1'>
        <div className='row'>
            ...
            <img className='mb-2' alt="logo-img" src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQHOlduzGuxZkbjroQiuujxbEqk8Okx3pXCnfFb1q5rKJEqrPuVANpAbOTPQHVyLgsh5A&usqp=CAU' style={{width:"180px"}}/>
            <h4><strong>Create an Account</strong></h4>
            <span>Already have an account? <Link to="/signin" style={{textDecoration:"none"}}><b>Sign in here</b></Link></span>
            </div>
            {/* <pre>{JSON.stringify(user)}</pre> */}
            <form>
            <TextField className='mt-2' onChange={handleChange} value={user.firstName} name="firstName" id="firstName" label="First Name" variant="outlined" style={{width:"100%"}}/>
            ...
            <TextField className='mt-3' onChange={handleChange} value={user.phone} name='phone' id="phone" label="Mobile" variant="outlined" style={{width:"100%"}}/>
        ...
        <Button className='mt-3' variant="contained" size="medium" style={{width:"100%"}} onClick={handleRegister}>
          Continue
        </Button>
            </div>
        </div>
